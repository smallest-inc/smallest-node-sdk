...
(0, vitest_1.describe)('Lightning', function () {
    ...
    (0, vitest_1.it)('should synthesize speech and return audio file', function () { return __awaiter(void 0, void 0, void 0, function () {
        var request, response, fs, outputPath, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, wavesClient.synthesizeLightningSpeech(request)];
                case 1:
                    response = _a.sent();
                    fs = require('fs');
                    outputPath = './test-output.wav';
                    fs.writeFileSync(outputPath, response.data);
                    console.log("Audio saved to ".concat(outputPath));
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.error('Error in synthesizeLightningSpeech test:', error_1);
                    throw error_1;
                case 3: return [2 /*return*/];
            }
        });
    }); });
    (0, vitest_1.it)('should synthesize speech and return audio file without wav header', function () { return __awaiter(void 0, void 0, void 0, function () {
        var request, response, fs, outputPath, wav, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 1:
                    response = _a.sent();
                    fs = require('fs');
                    outputPath = './test-output-no-wav-header.wav';
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Error in synthesizeLightningSpeech test:', error_2);
                    throw error_2;
                case 3: return [2 /*return*/];
            }
        });
